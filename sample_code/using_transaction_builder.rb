...
builder.input_addresses = [ Dash::Key.new(wif: "L1uyy5qTuGrVXrmrsvHWHgVzW9kKdrp27wBC7Vs6nZDTF2BRUVwy").to_wif_object ]
...
builder.unspent_outputs_provider_block = lambda do |addresses, outputs_amount, outputs_size, fee|
  txout = Dash::TransactionOutput.new(
    value: 50_000,
    script: Dash::PublicKeyAddress.parse("17XBj6iFEsf8kzDMGQk5ghZipxX49VXuaV").script,
...
builder.outputs = [ Dash::TransactionOutput.new(
                        value: 10_000, 
                        script: Dash::PublicKeyAddress.parse("17XBj6iFEsf8kzDMGQk5ghZipxX49VXuaV").script) ]

# 4. Specify the change address
builder.change_address = Dash::PublicKeyAddress.parse("1CBtcGivXmHQ8ZqdPgeMfcpQNJrqTrSAcG")
