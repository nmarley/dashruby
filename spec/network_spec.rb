...
describe Dash::Network do
  ...
  it "should have mainnet shared instance" do
    ...
    Dash::Network.mainnet.object_id.must_equal Dash::Network.mainnet.object_id
  end

  it "should have testnet shared instance" do
    testnet = Dash::Network.testnet
    ...
    Dash::Network.testnet.object_id.must_equal Dash::Network.testnet.object_id
  end
  
  it "should allow copying" do
    network = Dash::Network.testnet.dup
    network.object_id.wont_equal Dash::Network.testnet.object_id
    ...
    Dash::Network.testnet.mainnet?.must_equal false
    Dash::Network.testnet.testnet?.must_equal true
  end
