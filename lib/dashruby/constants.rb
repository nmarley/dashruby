module Dash
  ...
  # Duff is the smallest unit representable in Dash transactions.
  DUFF = 1

  # 100 mln duffs is one Dash
  COIN = 100_000_000

  # 1 bit is 100 duffs (1 millionth of a Dash)
  BIT  = 100
  ...
  # Threshold for Dash::Transaction#lock_time: below this value it is interpreted
