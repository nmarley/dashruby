# Dash script consists of opcodes ("operation codes") and raw binary data.
...
module Dash
  ...
  # a different namespace without the baggage of other Dash identifiers.
  module Opcodes
    ...
    # Dash-Qt executes all operators from OP_IF to OP_ENDIF even inside "non-executed" branch (to keep track of nesting).
  ...
  # Make all opcodes available as Dash::OP_...
  include Opcodes
  module Opcode
    include Opcodes
  end
