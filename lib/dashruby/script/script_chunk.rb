module Dash
  ...
  class ScriptChunk
    ...
    def self.with_data(data, offset: 0)
      ...
      opcode, _ = Dash::WireFormat.read_uint8(data: data, offset: offset)
      ...
      if opcode <= OP_PUSHDATA4
        ...
        if opcode < OP_PUSHDATA1
          ...
          pushdata_length, _ = Dash::WireFormat.read_uint8(data: data, offset: offset + 1)
          if !pushdata_length
          ...
          pushdata_length, _ = Dash::WireFormat.read_uint16le(data: data, offset: offset + 1)
          if !pushdata_length
          ...
          pushdata_length, _ = Dash::WireFormat.read_uint32le(data: data, offset: offset + 1)
          if !pushdata_length
